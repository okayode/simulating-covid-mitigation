...
class PINN_constantParam:
    ...
    def __init__(self, t, I, R, xi, layers, lb, ub):
...
model2 = PINN_constantParam(t_train, I_train, R_train, 0.25, layers, lb, ub)
model3 = PINN_constantParam(t_train, I_train, R_train, 0.50, layers, lb, ub)
model4 = PINN_constantParam(t_train, I_train, R_train, 0.75, layers, lb, ub)
